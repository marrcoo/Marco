...
local function iMarco(msg,MsgText)

if msg.forward_info_ then return false end


if msg.Director 
and (redis:get(marco..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(marco..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(marco..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(marco..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" then 
return false end 
print(MsgText[1] )
print(MsgText[2] )
...
if not redis:get(marco..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'📮¦ بواسطه ⋙「 '..NameUser..' 」 \n📬¦ المجموعه بالتأكيد ✓️ تم تعطيلها \n✓️') end  
...
if redis:get(marco..'lock_id'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)

local msgs = redis:get(marco..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local edited = (redis:get(marco..':edited:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)
...
..'📋¦ رسائلك •⊱ {'..arg.msgs..'} ⊰•\n➖'
local Kleshaidinfo = redis:get(marco..":infoiduser_public:"..arg.chat_id_) or redis:get(marco..":infoiduser")  

if Kleshaidinfo then 
local points = redis:get(marco..':User_Points:'..arg.chat_id_..arg.sender_user_id_) or 0
...
KleshaID = KleshaID:gsub("{البوت}",redis:get(marco..':NameBot:'))
KleshaID = KleshaID:gsub("{المطور}",SUDO_USER)
end
if redis:get(marco.."idphoto"..msg.chat_id_) then
...
local GroupName = (redis:get(marco..'group:name'..arg.ChatID) or '')
redis:set(marco..'linkGroup'..arg.ChatID,(data.invite_link_ or ""))
...
if not msg.Director and redis:get(marco..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(marco..":MsgIDPin:"..arg.ChatID,arg.reply_id)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not msg.Director and redis:get(marco..'lock_pin'..msg.chat_id_) then return "لا يمكنك الغاء التثبيت الامر مقفول من قبل الاداره" end
...
elseif redis:sismember(marco..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(marco..':MONSHA_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(marco..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(marco..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد الادمن\n🛠") 
elseif  redis:sismember(marco..'whitelist:'..arg.ChatID,UserID) then 
...
redis:set(marco..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
if data.status_.ID == "ChatMemberStatusMember" then 
Restrict(arg.ChatID,arg.UserID,1)  
sredis:set(marco..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
elseif redis:sismember(marco..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(marco..':MONSHA_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك نقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(marco..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(marco..'admins:'..msg.chat_id_,UserID) then 
...
redis:del(marco..":TqeedUser:"..arg.ChatID..UserID)
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
...
redis:del(marco..":TqeedUser:"..arg.ChatID..arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده  من المجموعه \n✓") 
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(marco..'whitelist:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مميز  في المجموعه \n✓") 
else
redis:hset(marco..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(marco..'whitelist:'..arg.ChatID,arg.UserID)
...
if redis:sismember(marco..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مميز  في المجموعه \n✓") 
end
redis:hset(marco..'username:'..UserID,'username',UserName)
redis:sadd(marco..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مميز  في المجموعه \n✓") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
NameUser = Hyper_Link_Name(data)
if not redis:sismember(marco..'whitelist:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
else
redis:srem(marco..'whitelist:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مميز  في المجموعه \n✓") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(marco..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓")
else
redis:srem(marco..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مميز  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(marco..'owners:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مدير  في المجموعه \n✓")
else
redis:hset(marco..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(marco..'owners:'..arg.ChatID,UserID)
...
UserName = arg.UserName
if redis:sismember(marco..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مدير  في المجموعه \n✓")
else
redis:hset(marco..'username:'..UserID, 'username',UserName)
redis:sadd(marco..'owners:'..arg.ChatID,UserID)
...
if not redis:sismember(marco..'owners:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
else
redis:srem(marco..'owners:'..arg.ChatID,arg.UserID)
...
if not redis:sismember(marco..'owners:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓")  
else
redis:srem(marco..'owners:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(marco..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ  في المجموعه \n✓") 
else
redis:hset(marco..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(marco..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(marco..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ  في المجموعه \n✓") 
else
redis:hset(marco..'username:'..UserID,'username',UserName)
redis:sadd(marco..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته منشئ  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(marco..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
else
redis:srem(marco..':MONSHA_BOT:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(marco..':MONSHA_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
else
redis:srem(marco..':MONSHA_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
ReUsername = ResolveUserName(data)
NameUser   = Hyper_Link_Name(data)
if redis:sismember(marco..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته ادمن  في المجموعه \n✓") 
else
redis:hset(marco..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(marco..'admins:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(marco..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته ادمن  في المجموعه \n✓") 
else
redis:hset(marco..'username:'..UserID,'username',UserName)
redis:sadd(marco..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته ادمن  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(marco..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
else
redis:srem(marco..'admins:'..arg.ChatID,arg.UserID)
...
local UserID = data.id_
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(marco..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
else
redis:srem(marco..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله ادمن  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
local maseegs = redis:get(marco..'msgs:'..arg.UserID..':'..arg.ChatID) or 1
local edited = redis:get(marco..':edited:'..arg.ChatID..':'..arg.UserID) or 0
local content = redis:get(marco..':adduser:'..arg.ChatID..':'..arg.UserID) or 0
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(marco..'msgs:'..UserID..':'..arg.ChatID) or 1
local edited = redis:get(marco..':edited:'..arg.ChatID..':'..UserID) or 0
local content = redis:get(marco..':adduser:'..arg.ChatID..':'..UserID) or 0
...
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n📛") end
GetUserID(UserID,function(arg,data)
if msg.SudoBase then redis:srem(marco..'gban_users',arg.UserID)  end 
Restrict(arg.ChatID,arg.UserID,2)
redis:srem(marco..'banned:'..arg.ChatID,arg.UserID)
StatusLeft(arg.ChatID,arg.UserID)
redis:srem(marco..'is_silent_users:'..arg.ChatID,arg.UserID)
NameUser = Hyper_Link_Name(data)
...
local UserID = data.id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n📛") end
if msg.SudoBase then redis:srem(marco..'gban_users',UserID)  end 
Restrict(arg.ChatID,UserID,2)
redis:srem(marco..'banned:'..arg.ChatID,UserID)
StatusLeft(arg.ChatID,UserID)
redis:srem(marco..'is_silent_users:'..arg.ChatID,UserID)
NameUser = Hyper_Link_Name(data)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم رفع القيود ان وجد  \n✓") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
if msg.SudoBase then redis:srem(marco..'gban_users',MsgText[2])  end 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not msg.Creator and not redis:get(marco.."lock_KickBan"..msg.chat_id_) then return "📛*¦* الامر معطل من قبل اداره المجموعة  \n🚶" end
...
NameUser = Hyper_Link_Name(data)
USERNAME = ResolveUserName(data)
if redis:sismember(marco..'banned:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره  من المجموعه \n✓") 
end

redis:hset(marco..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(marco..'banned:'..arg.ChatID,arg.UserID)
...
if redis:sismember(marco..'banned:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره  من المجموعه \n✓") 
end
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
redis:hset(marco..'username:'..arg.UserID, 'username',arg.UserName)
redis:sadd(marco..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم حظره  من المجموعه \n✓") 
...
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* عذرا هذا معرف قناة وليس حساب \n📛") end
redis:hset(marco..'username:'..arg.UserID,'username',USERNAME)
redis:setex(marco..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,500,NameUser)
redis:setex(marco..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,500,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* عذرا هذا معرف قناة وليس حساب \n📛") end
redis:hset(marco..'username:'..UserID,'username',arg.USERNAME)
redis:setex(marco..":uploadingsomeon:"..arg.ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(marco..":uploadingsomeon2:"..arg.ChatID..msg.sender_user_id_,500,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📇¦  » حسننا الان ارسل صلاحيات المشرف :\n\n¦1- صلاحيه تغيير المعلومات\n¦2- صلاحيه حذف الرسائل\n¦3- صلاحيه دعوه مستخدمين\n¦4- صلاحيه حظر وتقيد المستخدمين \n¦5- صلاحيه تثبيت الرسائل \n¦6- صلاحيه رفع مشرفين اخرين\n\n¦[*]- لرفع كل الصلاحيات ما عدا رفع المشرفين \n¦[**] - لرفع كل الصلاحيات مع رفع المشرفين \n\n🚸¦ يمكنك اختيار الارقام معا وتعيين الكنيه للمشرف في ان واحد مثلا : \n\n¦ 136 ماركو\n📬") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,USERNAME=MsgText[2]})
...
GetChatMember(arg.ChatID,arg.UserID,function(arg,data)
if (data.status_.ID == "ChatMemberStatusKicked" or redis:sismember(marco..'banned:'..arg.ChatID,arg.UserID)) then
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(marco..'banned:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء حظره  من المجموعه \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء حظره  من المجموعه \n✓") 
end
...
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(marco..'is_silent_users:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد كتمه  من المجموعه \n✓") 
else
redis:hset(marco..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(marco..'is_silent_users:'..arg.ChatID,arg.UserID)
...
if redis:sismember(marco..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد كتمه  من المجموعه \n✓") 
else
redis:hset(marco..'username:'..UserID,'username',UserName)
redis:sadd(marco..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم كتمه  من المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then 
...
if not redis:sismember(marco..'is_silent_users:'..arg.ChatID,arg.UserID) then 
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(marco..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء كتمه  من المجموعه \n✓") 
else
redis:srem(marco..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه \n✓") 
...
redis:setex(marco..'WiCmdLink'..msg.chat_id_..msg.sender_user_id_,500,true)
return '📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل  رابط مجموعتك 🍃'
end

if MsgText[1] == "انشاء رابط" then
if not msg.Creator then return "📛*¦* هذا الامر يخص {المطور,المنشئ الاساسي ,المنشئ} فقط  \n🚶" end
if not redis:get(marco..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(marco..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(marco..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(marco.."lock_linkk"..msg.chat_id_) then return "📡*¦* الامر معطل من قبل الادارة \n^"  end
if not redis:get(marco..'linkGroup'..msg.chat_id_) then return "📡*¦* اوه 🙀 لا يوجد رابط ☹️\n🔖*¦*لانشاء رابط ارسل { انشاء رابط } \n📡" end
local GroupName = redis:get(marco..'group:name'..msg.chat_id_)
local GroupLink = redis:get(marco..'linkGroup'..msg.chat_id_)
return "📬¦ رابـط الـمـجـمـوعه 💢\n🌿¦ "..Flter_Markdown(GroupName).." :\n\n["..GroupLink.."]\n"
end

if MsgText[1] == "ضع القوانين" then
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(marco..'rulse:witting'..msg.sender_user_id_,300,true)
return '📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل القوانين  للمجموعه 🍃'
end

if MsgText[1] == "القوانين" then
if not redis:get(marco..'rulse:msg'..msg.chat_id_) then 
return "📡*¦* مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه\n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n"
else 
return "*🔖¦القوانين :*\n"..redis:get(marco..'rulse:msg'..msg.chat_id_) 
end 
end
...
redis:set(marco..'num_msg_max'..msg.chat_id_,MsgText[2]) 
...
local NumLoop = tonumber(MsgText[2])
redis:set(marco..':Timer_Cleaner:'..msg.chat_id_,NumLoop) 
...
local Admins = redis:scard(marco..':MONSHA_Group:'..msg.chat_id_)
if Admins == 0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد منشئيين اساسييين ليتم مسحهم ✓" 
end
redis:del(marco..':MONSHA_Group:'..msg.chat_id_)
...
local Admins = redis:scard(marco..'admins:'..msg.chat_id_)
if Admins == 0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ادمنيه ليتم مسحهم ✓" 
end
redis:del(marco..'admins:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦ تم مسح {"..Admins.."} من الادمنيه في البوت \n✓"
end
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local Mn3Word = redis:scard(marco..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*¦* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(marco..':Filter_Word:'..msg.chat_id_)
...
redis:del(marco..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(marco..'welcome:msg'..msg.chat_id_) then 
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(marco..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(marco..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "📛¦ عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(marco..':MONSHA_BOT:'..msg.chat_id_)
...
if not msg.Creator then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local NumMDER = redis:scard(marco..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "📛¦ عذرا لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(marco..'owners:'..msg.chat_id_)
...
redis:del(marco..'banned:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local MKTOMEN = redis:scard(marco..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*¦* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(marco..'is_silent_users:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MKTOMEN.." *} من المكتومين  \n✓"
end

if MsgText[2] == 'المميزين' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local MMEZEN = redis:scard(marco..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*⚙️*¦ لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(marco..'whitelist:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MMEZEN.." *} من المميزين  \n✓"
end

if MsgText[2] == 'الرابط' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(marco..'linkGroup'..msg.chat_id_) then 
return "*⚙️*¦ لا يوجد رابط مضاف اصلا " 
end
redis:del(marco..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(marco..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(marco..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(marco..'about:witting'..msg.sender_user_id_,300,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الوصف  للمجموعه\n🛠" 
end

if MsgText[1] == "تاك للكل" then 
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(marco.."lock_takkl"..msg.chat_id_) then  return "📛*¦* الامر معطل من قبل الادراة" end 
return TagAll(msg) 
end
...
if redis:sismember(marco..':Filter_Word:'..arg.ChatID,Type_id) then 
return sendMsg(arg.ChatID,arg.MsgID,"📝*¦* هي بالتأكيد في قائمه المنع✓️")
else
redis:sadd(marco..':Filter_Word:'..arg.ChatID,Type_id) 
...
if redis:sismember(marco..':Filter_Word:'..arg.ChatID,Type_id) then 
redis:srem(marco..':Filter_Word:'..arg.ChatID,Type_id) 
...
kick_user(v.user_id_,arg.ChatID,function(arg,data)  
redis:srem(marco..':MONSHA_BOT:'..arg.ChatID,v.user_id_)
redis:srem(marco..'whitelist:'..arg.ChatID,v.user_id_)
redis:srem(marco..'owners:'..arg.ChatID,v.user_id_)
redis:srem(marco..'admins:'..arg.ChatID,v.user_id_)
end)
end
NumMem = NumMem + 1
...
redis:setex(marco..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(marco..'CheckExpire::'..msg.chat_id_) then 
redis:set(marco..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️¦ في مجموعه  » »  '..redis:get(marco..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if MsgText[2] == '1' then
redis:setex(marco..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(marco..'CheckExpire::'..msg.chat_id_) then 
redis:set(marco..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم تفعيل الاشتراك   👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم تفعيل الاشتراك  👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(marco..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(marco..'CheckExpire::'..msg.chat_id_) then 
redis:set(marco..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(marco..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(marco..'CheckExpire::'..msg.chat_id_) then 
redis:set(marco..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
local check_time = redis:ttl(marco..'ExpireDate:'..msg.chat_id_)
...
Getrtb = 'مطور اساسي ' 
elseif redis:sismember(marco..':SUDO_BOT:',arg.UserID) then
Getrtb = 'مطور ' 
elseif redis:sismember(marco..':MONSHA_Group:'..arg.ChatID,arg.UserID) then
Getrtb = 'منشى اساسي' 
elseif redis:sismember(marco..':MONSHA_BOT:'..arg.ChatID,arg.UserID) then
Getrtb = 'منشئ' 
elseif redis:sismember(marco..'owners:'..arg.ChatID,arg.UserID) then
Getrtb = 'المدير ' 
elseif redis:sismember(marco..'admins:'..arg.ChatID,arg.UserID) then
Getrtb = 'ادمن' 
elseif redis:sismember(marco..'whitelist:'..arg.ChatID,arg.UserID) then
Getrtb = 'مميز' 
else
Getrtb = 'عضو' 
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(marco..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(marco..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(marco..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(marco..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(marco..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(marco..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(marco..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(marco..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(marco..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
return '🧟‍♂*¦*  عدد جهہآتگ آلمـضـآفهہ‏‏ » 【'..(redis:get(marco..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..'】 . \n🐾'
end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:set(marco..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if redis:get(marco..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(marco..'welcome:msg'..msg.chat_id_))
else 
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(marco..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ اساسي  في المجموعه \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته منشئ اساسي  في المجموعه \n✓") 
redis:hset(marco..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(marco..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if redis:sismember(marco..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ اساسي  في المجموعه \n✓") 
else
redis:hset(marco..'username:'..UserID,'username',arg.UserName)
redis:sadd(marco..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته منشئ اساسي  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not redis:sismember(marco..':MONSHA_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ اساسي  في المجموعه \n✓") 
redis:srem(marco..':MONSHA_Group:'..arg.ChatID,arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
UserName = Flter_Markdown(arg.UserName)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(marco..':MONSHA_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
else
redis:srem(marco..':MONSHA_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ اساسي  في المجموعه \n✓")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
redis:del(marco..":awamer_Klesha_m1:")
redis:del(marco..":awamer_Klesha_m2:")
redis:del(marco..":awamer_Klesha_m3:")
redis:del(marco..":awamer_Klesha_mtwr:")
redis:del(marco..":awamer_Klesha_mrd:")
redis:del(marco..":awamer_Klesha_mf:")
redis:del(marco..":awamer_Klesha_m:")
...
redis:del(marco..":infoiduser_public:"..msg.chat_id_)
...
if not msg.Creator then return "📛*¦* هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  \n🚶" end
redis:setex(marco..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
elseif redis:sismember(marco..'admins:'..msg.chat_id_,UserID) then 
rinkuser = 6
elseif redis:sismember(marco..'whitelist:'..msg.chat_id_,UserID) then 
rinkuser = 7
else
rinkuser = 8
end
...
if redis:sismember(marco..':MONSHA_Group:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المنشئ الاساسي ✓️\n"
end 
if redis:sismember(marco..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المنشئ ✓️\n"
end 
if redis:sismember(marco..'owners:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المدير ✓️\n"
end 
if redis:sismember(marco..'admins:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من الادمن ✓️\n"
end 
if redis:sismember(marco..'whitelist:'..msg.chat_id_,UserID) then
...
redis:srem(marco..':MONSHA_Group:'..msg.chat_id_,UserID)
redis:srem(marco..':MONSHA_BOT:'..msg.chat_id_,UserID)
redis:srem(marco..'owners:'..msg.chat_id_,UserID)
redis:srem(marco..'admins:'..msg.chat_id_,UserID)
redis:srem(marco..'whitelist:'..msg.chat_id_,UserID)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local list = redis:hgetall(marco..":AwamerBotArray2:"..msg.chat_id_)
local list2 = redis:hgetall(marco..":AwamerBotArray:"..msg.chat_id_)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local Awammer 	= redis:del(marco..":AwamerBot:"..msg.chat_id_)
redis:del(marco..":AwamerBotArray:"..msg.chat_id_)
redis:del(marco..":AwamerBotArray2:"..msg.chat_id_)
if Awammer ~= 0 then
...
for k, Marco in pairs(XMarco) do if MsgText[2]:match(Marco) then  checkAmr = true end end      
if checkAmr then
redis:setex(marco..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "📭¦ حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان \n..."
else
return "📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n🚶"
end
else
redis:setex(marco..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if MsgText[2] then
local checkk = redis:hdel(marco..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
local AmrOld = redis:hgetall(marco..":AwamerBotArray:"..msg.chat_id_)
amrnew = ""
amrold = ""
...
redis:hdel(marco..":AwamerBotArray:"..msg.chat_id_,Amor)
...
redis:setex(marco..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(marco..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(marco..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(marco..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مطور  في البوت \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مطور  في البوت \n✓") 
redis:hset(marco..'username:'..arg.UserID,'username',RUSERNAME)
redis:sadd(marco..':SUDO_BOT:',arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
redis:hset(marco..'username:'..UserID,'username',ReUsername)
...
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(marco..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مطور  في البوت \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مطور  في البوت \n✓") 
redis:srem(marco..':SUDO_BOT:',arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
redis:setex(marco..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(marco..':WELCOME_BOT')
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(marco..':NameBot:')..[[ 🎖
...
redis:setex(marco..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '📭¦ حسننا عزيزي 🍁\n📋¦ الان قم بارسال الكليشه \n🛠' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(marco..':addnumberusers',MsgText[2]) 
return '💱*¦* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*¦* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(marco..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🔝" then 
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
return '📮*¦* عدد المجموعات المفعلة » `'..redis:scard(marco..'group:ids')..'`  ➼' 
end
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(marco.."lockidedit") then return "📛*¦* الامر معطل من قبل المطور الاساسي  \n🚶" end
redis:del(marco..":infoiduser")
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(marco.."lockidedit") then return "📛*¦* تعيين الايدي معطل من قبل المطور الاساسي  \n🚶" end
redis:setex(marco..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '📮*¦* حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n قناه الكلايش : [@Change_id] \n➼' 
end
...
return redis:get(marco..":TEXT_SUDO") or '🗃¦ لا توجد كليشه المطور .\n📰¦ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="اذاعه بالتثبيت 📬" then
if not msg.SudoUser then return"📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(marco..'lock_brod') then return "📡*¦* الاذاعه مقفوله من قبل المطور الاساسي  🚶" end
redis:setex(marco..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "📭¦ حسننا الان ارسل رساله ليتم اذاعتها بالتثبيت  \n🔛" 
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(marco..'lock_brod') then 
return "📡*¦* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(marco..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(marco..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(marco..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(marco..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:hset(marco..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(marco..'gban_users',arg.UserID)
...
if redis:sismember(marco..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره عام  من المجموعات \n✓") 
else
redis:hset(marco..'username:'..UserID,'username',UserName)
...
if GeneralBanned(arg.UserID) then 
redis:srem(marco..'gban_users',arg.UserID)
...
if not redis:sismember(marco..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء حظره العام  من المجموعات \n✓") 
else
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(marco..'welcom:witting'..msg.sender_user_id_,
marco..'rulse:witting'..msg.sender_user_id_,
marco..'rulse:witting'..msg.sender_user_id_,
marco..'name:witting'..msg.sender_user_id_,
marco..'about:witting'..msg.sender_user_id_,
marco..'fwd:all'..msg.sender_user_id_,
marco..'fwd:pv'..msg.sender_user_id_,
marco..'fwd:groups'..msg.sender_user_id_,
marco..'namebot:witting'..msg.sender_user_id_,
marco..'addrd_all:'..msg.sender_user_id_,
marco..'delrd:'..msg.sender_user_id_,
marco..'addrd:'..msg.sender_user_id_,
marco..'delrdall:'..msg.sender_user_id_,
marco..'text_sudo:witting'..msg.sender_user_id_,
marco..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
marco..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,
marco..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,
marco..'addrd:'..msg.chat_id_..msg.sender_user_id_,
marco..':KStart:'..msg.chat_id_..msg.sender_user_id_,
marco.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_,
marco..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,
marco..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,
marco..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,
marco..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,
marco..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,
marco..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,
marco..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
marco..":ForceSub:"..msg.sender_user_id_,
marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
return '👨🏾‍🔧¦ اصدار سورس ماركو : *v'..version..'* \n📡'
end
...
redis:set(marco..":VERSION",GetVerison)
return false
else
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ماركو يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : ماركو 🍃",url="t.me/F888w"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : ماركو](t.me/F888w)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 📈" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
return 'الاحصائيات : 📈 \n\n👥*¦* عدد المجموعات المفعله : '..redis:scard(marco..'group:ids')..'\n👤*¦* عدد المشتركين في البوت : '..redis:scard(marco..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(marco..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(marco..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:del(marco..':Text_Start')
return "📭¦ تم مسح كليشه الستارت "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local names 	= redis:exists(marco..'replay:'..msg.chat_id_)
local photo 	= redis:exists(marco..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(marco..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(marco..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(marco..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(marco..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(marco..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(marco..'replay:'..msg.chat_id_,marco..'replay_photo:group:'..msg.chat_id_,marco..'replay_voice:group:'..msg.chat_id_,
marco..'replay_animation:group:'..msg.chat_id_,marco..'replay_audio:group:'..msg.chat_id_,marco..'replay_sticker:group:'..msg.chat_id_,marco..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(marco..'replay:all')
local photo 	= redis:exists(marco..'replay_photo:group:')
local voice 	= redis:exists(marco..'replay_voice:group:')
local imation 	= redis:exists(marco..'replay_animation:group:')
local audio 	= redis:exists(marco..'replay_audio:group:')
local sticker 	= redis:exists(marco..'replay_sticker:group:')
local video 	= redis:exists(marco..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(marco..'replay:all',marco..'replay_photo:group:',marco..'replay_voice:group:',marco..'replay_animation:group:',marco..'replay_audio:group:',marco..'replay_sticker:group:',marco..'replay_video:group:')
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:set(marco..'delrdall:'..msg.sender_user_id_,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:set(marco..'delrd:'..msg.sender_user_id_,true)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local names  	= redis:hkeys(marco..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(marco..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(marco..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(marco..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(marco..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(marco..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(marco..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(marco..'replay:all')
local photo 	= redis:hkeys(marco..'replay_photo:group:')
local voice 	= redis:hkeys(marco..'replay_voice:group:')
local imation 	= redis:hkeys(marco..'replay_animation:group:')
local audio 	= redis:hkeys(marco..'replay_audio:group:')
local sticker 	= redis:hkeys(marco..'replay_sticker:group:')
local video 	= redis:hkeys(marco..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*¦* لا يوجد ردود مضافه حاليا \n❕' 
end
local ii = 1
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:setex(marco..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(marco..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭¦ حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(marco..'namebot:witting'..msg.sender_user_id_,300,true)
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(marco..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(marco..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_)
redis:setex(marco..":changawmer:"..msg.chat_id_..msg.sender_user_id_,900,MsgText[1])
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(marco..":awamer_Klesha_m:")
if textD then
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(marco..":awamer_Klesha_m1:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(marco..":awamer_Klesha_m2:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(marco..":awamer_Klesha_m3:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(marco..":awamer_Klesha_mtwr:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(marco..":awamer_Klesha_mrd:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(marco..":awamer_Klesha_mf:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
if not redis:get(marco.."lock_leftgroup"..msg.chat_id_) then  return "📛*¦* امر المغادره معطل من قبل اداره المجموعة  \n🚶" end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"👨🏼‍⚕️¦ اهلا عزيزي , لقد تم طردك من المجموعه بامر منك \n🔖¦ اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n🔖¦فهذا رابط المجموعه 💯\n🌿¦"..Flter_Markdown(redis:get(marco..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(marco..'linkGroup'..msg.chat_id_).."]\n")
...
`git clone https://github.com/marrcoo/Marco.git ;cd Marco;chmod +x ins;./ins
`
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/marrcoo/MarcoFiles/master/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/marrcoo/MarcoFiles/master/plugins/"..FileName)
if res == 200 then
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
if redis:get(marco..":UserNameChaneel") then
return "📑¦ اهلا عزيزي المطور \n🔖¦ الاشتراك بالتأكيد مفعل"
else
redis:setex(marco..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local SubDel = redis:del(marco..":UserNameChaneel")
if SubDel == 1 then
...
local function dMarco(msg)

if msg.type == "pv" then 

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(marco..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(marco..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛¦* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(marco..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(marco..'users',msg.sender_user_id_)
SUDO_USER = redis:hgetall(marco..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
SUDO_USERR = "⚖️¦ مـعرف آلمـطـور  : "..SUDO_USER
else
...
text = [[💯¦ مـرحبآ آنآ بوت آسـمـي []]..redis:get(marco..':NameBot:')..[[] 🎖
💰¦ آختصـآصـي حمـآيهہ‏‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‏‏ وآلتگرآر وآلخ...
...
GetUserID(msg.sender_user_id_,function(arg,data)
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
text = redis:get(marco..':Text_Start') or text
local edited = (redis:get(marco..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local points = redis:get(marco..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
local Emsgs = redis:get(marco..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
text = text:gsub("{البوت}",redis:get(marco..':NameBot:'))
...
local MSG_ID = (redis:get(marco.."USER_MSG_TWASEL"..data.forward_info_.date_) or 1)
msg = arg.msg
local SendOk = false
...
if not redis:get(marco..'lock_twasel') then
...
redis:setex(marco.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group =====================================
if redis:get(marco..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(marco..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(marco..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.content_ and msg.content_.caption_ then redis:hset(marco..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then 
redis:del(marco..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
redis:hset(marco..'replay:'..msg.chat_id_,klma,msg.text)
...
redis:hset(marco..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(marco..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(marco..'replay_voice:group:'..msg.chat_id_,klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(marco..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(marco..'replay_animation:group:'..msg.chat_id_,klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(marco..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(marco..'replay_video:group:'..msg.chat_id_,klma,msg.content_.video_.video_.persistent_id_)
redis:del(marco..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(marco..'replay_audio:group:'..msg.chat_id_,klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(marco..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(marco..'replay_sticker:group:'..msg.chat_id_,klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(marco..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(marco..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(marco..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.caption_ then redis:hset(marco..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
redis:del(marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر\n❕")
end
redis:hset(marco..'replay:all',klma,msg.text)
...
redis:hset(marco..'replay_photo:group:',klma,photo_id)
redis:del(marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(marco..'replay_voice:group:',klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(marco..'replay_animation:group:',klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(marco..'replay_video:group:',klma,msg.content_.video_.video_.persistent_id_)
redis:del(marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(marco..'replay_audio:group:',klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(marco..'replay_sticker:group:',klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(marco..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.Director and (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(marco.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(marco.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_)
redis:set(marco..'linkGroup'..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين الرابط بنجاح  ")
return false
end

if msg.Creator and redis:get(marco..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(marco..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_)
redis:set(marco..":infoiduser_public:"..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة الايدي بنجاح \n📮¦ يمكنك تجربة الامر الان ")
return false
end

if msg.SuperCreator and redis:get(marco..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_) then 

NameUser = redis:get(marco..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
UserID = redis:get(marco..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
if not msg.text:match("[1234567]") and not msg.text:match("[*]") and not msg.text:match("[*][*]") then
redis:del(marco..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
redis:del(marco..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(marco..'admins:'..msg.chat_id_,UserID)
local trues = "✓"
local falses = "✖️"
...
if msg.Creator and redis:get(marco..":changawmer:"..msg.chat_id_..msg.sender_user_id_) and not redis:get(marco..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
local amr = redis:get(marco..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
if amr == "م1" then
redis:set(marco..":awamer_Klesha_m1:",msg.text)
elseif amr == "م2" then
redis:set(marco..":awamer_Klesha_m2:",msg.text)
elseif amr == "م3" then
redis:set(marco..":awamer_Klesha_m3:",msg.text)
elseif amr == "م المطور" then
redis:set(marco..":awamer_Klesha_mtwr:",msg.text)
elseif amr == "اوامر الرد" then
redis:set(marco..":awamer_Klesha_mrd:",msg.text)
elseif amr == "اوامر الملفات" then
redis:set(marco..":awamer_Klesha_mf:",msg.text)
elseif amr == "الاوامر" then
redis:set(marco..":awamer_Klesha_m:",msg.text)
end
redis:del(marco..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة التعليمات بنجاح \n📮¦ يمكنك تجربة الامر *{"..amr.."}* ")
end


if msg.SudoUser and redis:get(marco..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(marco..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_)
redis:set(marco..":infoiduser",msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة الايدي بنجاح \n📮¦ يمكنك تجربة الامر الان ")
return false
end
...
if msg.Director and redis:get(marco..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(marco..":AwamerBotArray2:"..msg.chat_id_)
Amr = redis:get(marco..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
local checknewamr = false
for k, Marco in pairs(XMarco) do 
local cceck,sec = Marco:gsub("[(]"..Amr.."[)]","("..msg.text..")")
if sec ~= 0 then
redis:hset(marco..":AwamerBotArray:"..msg.chat_id_,cceck,Marco)
redis:hset(marco..":AwamerBotArray2:"..msg.chat_id_,msg.text,Amr)
end
end  
...
redis:hset(marco..":AwamerBot:"..msg.chat_id_,msg.text,Amr)
sendMsg(msg.chat_id_,msg.id_,"📑¦ تم تغيير الامر القديم ["..Amr.."] \n🔖¦ الى الامر الجديد ["..msg.text.."]\n...")
end
redis:del(marco..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and not redis:get(marco..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) and redis:get(marco..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(marco..":AwamerBotArray2:"..msg.chat_id_)
local Amr = redis:get(marco..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
...
redis:del(marco..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and redis:get(marco..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) then
local checkAmr = false
for k, Marco in pairs(XMarco) do if msg.text:match(Marco) then checkAmr = true end end      
if checkAmr then
sendMsg(msg.chat_id_,msg.id_,"??¦ حسننا عزيزي , لتغير امر {* "..msg.text.." *} \n¦ ارسل الامر الجديد الان \n...")
redis:setex(marco..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,900,msg.text)
else
sendMsg(msg.chat_id_,msg.id_,"📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n🚶")
end
redis:del(marco..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
if msg.Director and redis:get(marco..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) then
local checkk = redis:hdel(marco..":AwamerBotArray2:"..msg.chat_id_,msg.text)
...
redis:del(marco..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
local checkk = redis:hdel(marco..":AwamerBot:"..msg.chat_id_,msg.text)
if checkk ~=0 then
tiires =  "📭¦ تم مسح الامر {* "..msg.text.." *} من قائمه الاومر \n..."
else
tiires = "📛*¦* هذا الامر ليس موجود ضمن الاوامر المضافه  \n🚶"
...
if msg.SudoBase and redis:get(marco..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_) then
...
redis:set(marco..":SUDO_ID:",UserID)
local usero = arg.USERNAME:gsub([[\_]],"_")
redis:hset(marco..'username:'..UserID,'username',usero)
...
redis:del(marco..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_)
return false 
end


if redis:get(marco..":ForceSub:"..msg.sender_user_id_) then
redis:del(marco..":ForceSub:"..msg.sender_user_id_)
if msg.text:match("^@[%a%d_]+$") then
...
redis:set(marco..":UserNameChaneel",msg.text)
...
if redis:get(marco..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(marco..'namebot:witting'..msg.sender_user_id_)
redis:set(marco..':NameBot:',msg.text)
Start_Bot() 
...
redis:hdel(marco..'replay_animation:group:',msg.text)
redis:hdel(marco..'replay_audio:group:',msg.text)
redis:hdel(marco..'replay_sticker:group:',msg.text)
redis:hdel(marco..'replay_video:group:',msg.text)
redis:setex(marco..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] ✓\n\n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n➼")
end
end

if redis:get(marco..':KStart:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(marco..':KStart:'..msg.chat_id_..msg.sender_user_id_)
redis:set(marco..':Text_Start',msg.text)
...
if redis:get(marco..'delrdall:'..msg.sender_user_id_) then
redis:del(marco..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(marco..'replay:all',msg.text)
local photo =redis:hget(marco..'replay_photo:group:',msg.text)
local voice = redis:hget(marco..'replay_voice:group:',msg.text)
local animation = redis:hget(marco..'replay_animation:group:',msg.text)
local audio = redis:hget(marco..'replay_audio:group:',msg.text)
local sticker = redis:hget(marco..'replay_sticker:group:',msg.text)
local video = redis:hget(marco..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'🛑*¦* هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(marco..'replay:all',msg.text)
redis:hdel(marco..'replay_photo:group:',msg.text)
redis:hdel(marco..'replay_voice:group:',msg.text)
redis:hdel(marco..'replay_audio:group:',msg.text)
redis:hdel(marco..'replay_animation:group:',msg.text)
...
if redis:get(marco..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(marco..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(marco..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*¦* تم وضع الكليشه بنجاح كلاتي 👋??\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(marco..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(marco..'welcom:witting'..msg.sender_user_id_) 
redis:set(marco..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*¦* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(marco..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(marco..'rulse:witting'..msg.sender_user_id_) 
redis:set(marco..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*¦* مرحبآ عزيزي\n📦¦ تم حفظ القوانين بنجاح ✓\n🔖¦ ارسل [[ القوانين ]] لعرضها \n🛑✓')
end
if redis:get(marco..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(marco..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(marco..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(marco..'about:witting'..msg.sender_user_id_) 
...
if redis:get(marco..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(marco..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(marco..'users')  
local groups = redis:smembers(marco..'group:ids')
...
if redis:get(marco..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(marco..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(marco..'users')
if #pv >= 300 then
...
if redis:get(marco..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(marco..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(marco..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(marco..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'📑*¦* عدد المجموعات •⊱ { *'..#groups..'*  } ⊰•\n🗣*¦* تـم الاذاعه بالتثبيت بنجاح ✓')
end 

if redis:get(marco..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(marco..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(marco..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'📑¦ اهلا عزيزي المطور \n🔖¦ جاري نشر الرساله للمجموعات ...')			
end
...
if msg.forward_info_ and redis:get(marco..'fwd:'..msg.sender_user_id_) then
redis:del(marco..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(marco..'users')
local groups = redis:smembers(marco..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(marco..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(marco..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(marco..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'🚸 ¦ تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(marco..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(marco..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
redis:hdel(marco..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(marco..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(marco..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(marco..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(marco..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(marco..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جواب الرد \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] \n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n➼")
end
end

if redis:get(marco..'delrd:'..msg.sender_user_id_) then
redis:del(marco..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(marco..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(marco..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(marco..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(marco..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(marco..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(marco..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(marco..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'🛑*¦* هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(marco..'replay:'..msg.chat_id_,msg.text)
...
print(" -- pinned -- ")
local msg_pin_id = redis:get(marco..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and not msg.OurBot and redis:get(marco..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(marco..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(marco..'group:name'..arg.chat_id_,arg.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(marco..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(marco..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(marco..'welcome:get'..msg.chat_id_)
end
redis:setex(marco..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if (msg.content_.ID == "MessageChatAddMembers") then
if redis:get(marco..'welcome:get'..msg.chat_id_) then
if msg.adduserType then
welcome = (redis:get(marco..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(marco..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
local edited = (redis:get(marco..':edited:'..msg.chat_id_..':'..msg.adduser) or 0)
local points = redis:get(marco..':User_Points:'..msg.chat_id_..msg.adduser) or 0
local msgs = redis:get(marco..'msgs:'..msg.adduser..':'..msg.chat_id_) or 1

if msg.adduser == SUDO_ID then 
gtupe = 'المطور الاساسي' 
elseif redis:sismember(marco..':SUDO_BOT:',msg.adduser) then 
gtupe = 'المطور'
elseif msg.GroupActive and redis:sismember(marco..':MONSHA_Group:'..msg.chat_id_,msg.adduser) then 
gtupe = 'منشئ اساسي'
elseif msg.GroupActive and redis:sismember(marco..':MONSHA_BOT:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المنشىء'
elseif msg.GroupActive and redis:sismember(marco..'owners:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المدير' 
elseif msg.GroupActive and redis:sismember(marco..'admins:'..msg.chat_id_,msg.adduser) then 
gtupe = 'الادمن'
elseif msg.GroupActive and redis:sismember(marco..'whitelist:'..msg.chat_id_,msg.adduser) then 
gtupe = 'عضو مميز'
...
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(marco..'group:name'..msg.chat_id_) or '')))
...
local welcome = welcome:gsub("{البوت}",redis:get(marco..':NameBot:'))
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(marco..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(marco..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين  👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
...
if msg.edited and not msg.SuperCreator and redis:get(marco.."antiedit"..msg.chat_id_) then 
...
local monsha = redis:smembers(marco..':MONSHA_Group:'..msg.chat_id_)
Rwers = ""
...
local info = redis:hgetall(marco..'username:'..v) if info and info.username and info.username:match("@[%a%d_]+") then usersmnc = usersmnc..info.username.." - " end
sendMsg(v,0,"📇¦ هناك شخص قام بالتعديل \n👲🏼¦ الاسم : ⋙「 "..NameUser.." 」 "..uuseri.."\n🀄️¦ الايدي : `"..msg.sender_user_id_.."`\n📬¦ رتبته : "..Getrtba(msg.sender_user_id_,msg.chat_id_).."\n🔌¦ نوع التعديل : "..Rwers.."\n📱¦ المجموعة : "..Flter_Markdown((redis:get(marco..'group:name'..msg.chat_id_) or '')).."\n🔅¦ الرابط : "..redis:get(marco..'linkGroup'..msg.chat_id_).." \n🚸" )
end
end
...
if not msg.forward_info_ and msg.content_.ID ~= "MessagePhoto" and redis:get(marco..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(marco..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(marco..'num_msg_max'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then 
redis:setex(marco..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',30,true)
...
redis:setex(marco..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end


if msg.forward_info_ then
if redis:get(marco..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(marco..'lock_woring'..msg.chat_id_) and not redis:get(marco..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(marco..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(marco..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and msg.content_.ID ~= "MessageText" and redis:get(marco..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data) 
print("\27[1;31m Msg Del becuse send Edit \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*¦* لا يمكنني مسح الرساله المخالفه .\n🎟*¦* لست مشرف او ليس لدي صلاحيه  الحذف \n ❕')    
end
if redis:get(marco..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
...
return false
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(marco..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(marco..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
or msg.text:match("[Ww][Ww][Ww].") 
or msg.text:match(".[Cc][Oo][Mm]")) 
and redis:get(marco..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(marco..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(marco..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("ه‍") or msg.text:match("ی") or msg.text:match("ک")) and redis:get(marco.."lock_pharsi"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif KlmatMmno3(msg.text) and redis:get(marco.."lock_mmno3"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("[a-zA-Z]") and redis:get(marco.."lock_lang"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#.+") and redis:get(marco..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(marco..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(marco..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(marco..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(marco..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessagePhoto" then
if redis:get(marco..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(marco..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageVideo" then
if redis:get(marco..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(marco..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageDocument" and redis:get(marco..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageSticker" and redis:get(marco..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAnimation" then
if redis:get(marco..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(marco..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageContact" and redis:get(marco..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageLocation" and redis:get(marco..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageVoice" and redis:get(marco..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageGame" and redis:get(marco..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAudio" and redis:get(marco..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.reply_markup and  msg.reply_markup.ID == "replyMarkupInlineKeyboard" and redis:get(marco..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(marco..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(marco..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(marco..'replay'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)
local Replay = false

Replay = redis:hget(marco..'replay:all',msg.text)
if Replay then
...
Replay = redis:hget(marco..'replay:'..msg.chat_id_,msg.text)
if Replay then 
Replay = convert_Klmat(msg,data,Replay,true)
sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay)) 
return false
...
Replay = redis:hget(marco..'replay_photo:group:',msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
...
Replay = redis:hget(marco..'replay_voice:group:',msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(marco..'replay_animation:group:',msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(marco..'replay_audio:group:',msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(marco..'replay_sticker:group:',msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(marco..'replay_video:group:',msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(marco..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendPhoto(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(marco..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVoice(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(marco..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAnimation(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(marco..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAudio(msg.chat_id_,msg.id_,Replay,"",Caption)  
...
Replay = redis:hget(marco..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(marco..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(marco..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVideo(msg.chat_id_,msg.id_,Replay,Caption)
...
if msg.text and redis:get(marco.."lock_rdodSource"..msg.chat_id_) then
...
if redis:get(marco..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(marco..'ExpireDate:'..msg.chat_id_)
SUDO_USER = redis:hgetall(marco..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
