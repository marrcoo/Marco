...
var = 'هذا البوت 🙄☝🏿' 
elseif UserID == 332717942 or UserID == 1614375843  then 
var = 'مطور السورس'
elseif  UserID == SUDO_ID then
var = redis:get(amrko..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
...
var = redis:get(amrko..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
...
var = redis:get(amrko..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
if redis:get(amrko..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'📬¦ المجموعه بالتأكيد ✓️ تم تفعيلها \n📮¦ بواسطه ⋙「 '..NameUser..' 」 \n') end
...
if UserID == 332717942 or UserID == 1614375843 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
